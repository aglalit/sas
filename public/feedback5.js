...
if (subjectUrl === 'all') {
  ...
  data[0].forEach(function (el) {
    for (var i in el.polls) {
      var i_inner = i;
      if (i === 'ba_2019_q4_elective1' || i === 'ba_2019_q4_elective2' || i === 'ba_2019_q4_elective3' || i === 'ba_2019_q4_major1' || i === 'ba_2019_q4_major2' || i === 'ba_2019_q4_major3') {
        i_inner = 'ba_2019_q4_electives';
      }
...
function displaySubject (data, subject) {
  ...
  if (subject === 'ba_2019_q4_electives') {
    data[0].forEach(function (el) {
      if (el.polls.ba_2019_q4_elective1) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_elective1));
      if (el.polls.ba_2019_q4_elective2) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_elective2));
      if (el.polls.ba_2019_q4_elective3) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_elective3));
      if (el.polls.ba_2019_q4_major1) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_major1));
      if (el.polls.ba_2019_q4_major2) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_major2));
      if (el.polls.ba_2019_q4_major3) dataParsed.unshift(JSON.parse(el.polls.ba_2019_q4_major3));
    });
  } else {
    data[0].forEach(function (el) {
