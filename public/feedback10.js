...
if (subjectUrl === 'all') {
  ...
  data[0].forEach(function (el) {
    for (var i in el.polls) {
      var i_inner = i;
      if (i === 'ba_2021_q1_elective1' || i === 'ba_2021_q1_elective2' || i === 'ba_2021_q1_elective3' || i === 'ba_2021_q1_elective4' || i === 'ba_2021_q1_major1' || i === 'ba_2021_q1_major2' || i === 'ba_2021_q1_major3' || i === 'ba_2021_q1_major4') {
        i_inner = 'ba_2021_q1_electives';
      }
...
function displaySubject (data, subject) {
  ...
  if (subject === 'ba_2021_q1_electives') {
    data[0].forEach(function (el) {
      if (el.polls.ba_2021_q1_elective1) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_elective1));
      if (el.polls.ba_2021_q1_elective2) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_elective2));
      if (el.polls.ba_2021_q1_elective3) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_elective3));
      if (el.polls.ba_2021_q1_elective4) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_elective4));
      if (el.polls.ba_2021_q1_major1) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_major1));
      if (el.polls.ba_2021_q1_major2) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_major2));
      if (el.polls.ba_2021_q1_major3) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_major3));
      if (el.polls.ba_2021_q1_major4) dataParsed.unshift(JSON.parse(el.polls.ba_2021_q1_major4));
    });
  } else {
    data[0].forEach(function (el) {
