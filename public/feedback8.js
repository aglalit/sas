...
if (subjectUrl === 'all') {
  ...
  data[0].forEach(function (el) {
    for (var i in el.polls) {
      var i_inner = i;
      if (i === 'ba_2020_q3_elective1' || i === 'ba_2020_q3_elective2' || i === 'ba_2020_q3_elective3' || i === 'ba_2020_q3_elective4' || i === 'ba_2020_q3_major1' || i === 'ba_2020_q3_major2' || i === 'ba_2020_q3_major3') {
        i_inner = 'ba_2020_q3_electives';
      }
...
function displaySubject (data, subject) {
  ...
  if (subject === 'ba_2020_q3_electives') {
    data[0].forEach(function (el) {
      if (el.polls.ba_2020_q3_elective1) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_elective1));
      if (el.polls.ba_2020_q3_elective2) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_elective2));
      if (el.polls.ba_2020_q3_elective3) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_elective3));
      if (el.polls.ba_2020_q3_elective4) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_elective4));
      if (el.polls.ba_2020_q3_major1) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_major1));
      if (el.polls.ba_2020_q3_major2) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_major2));
      if (el.polls.ba_2020_q3_major3) dataParsed.unshift(JSON.parse(el.polls.ba_2020_q3_major3));
    });
  } else {
    data[0].forEach(function (el) {
  ...
  dataParsed.forEach(function (el, index) {
    ...
    if (dataNumbers[entry] === undefined) {
      dataNumbers[entry] = {};
      for (const key in el) {
        if (key !== 'online' && el[key] >= 1 && el[key] <= 10) {
