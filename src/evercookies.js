 ...
 function idb() {
  ...
  function Evercookie(options) {
    ...
    this.evercookie_lso = function (name, value) {
      ...
      if (swfobject) {swfobject.embedSWF(_ec_baseurl + _ec_asseturi + _ec_swf_file_name, "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);}
    };
    ...
    this.evercookie_history = function (name, value) {
      ...
      if (value !== undefined) {
        ...
        base = this.encode(value.substr(0,20)).split("");
