...
app.get('/polls/global-issues-part-2', function(req, res) {

  res.render('global-issues-part-2', {user: req.user})
});

app.post('/polls/global-issues-part-2', function(req, res) {
  Session.findOne({
    'session_id': req.session.id
  }, function(err, session) {
    if (err)
    ...
    if (session) {
      var now = new Date();
      session.polls.GI_part2.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
      session.polls.GI_part2.LECTURES["Оцените сложность содержания лекций"] = parseInt(req.body["Оцените сложность содержания лекций"]);
      session.polls.GI_part2.LECTURES["Насколько новым для вас было содержание лекций"] = parseInt(req.body["Насколько новым для вас было содержание лекций"]);
      session.polls.GI_part2.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием лекций"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения под воздействием лекций"]);
      session.polls.GI_part2.LECTURES["Что вам больше всего понравилось на лекциях?"] = req.body["Что вам больше всего понравилось на лекциях?"];
      session.polls.GI_part2.LECTURES["Что вам больше всего не понравилось на лекциях?"] = req.body["Что вам больше всего не понравилось на лекциях?"];

      session.polls.GI_part2.SEMINARS["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"] = req.body["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"];
      session.polls.GI_part2.SEMINARS["Оцените, насколько понятной для вас была установка на групповую работу"] = req.body["Оцените, насколько понятной для вас была установка на групповую работу"];
      session.polls.GI_part2.SEMINARS["Укажите имя и фамилию куратора, организовывавшего групповую работу"] = req.body["Укажите имя и фамилию куратора, организовывавшего групповую работу"];
      session.polls.GI_part2.SEMINARS["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"] = parseInt(req.body["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"]);
      session.polls.GI_part2.SEMINARS["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"] = parseInt(req.body["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"]);
      session.polls.GI_part2.SEMINARS["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = parseInt(req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"]);
      session.polls.GI_part2.SEMINARS["Что для вас было самым сложным в групповой работе?"] = req.body["Что для вас было самым сложным в групповой работе?"];
      session.polls.GI_part2.SEMINARS["Что для вас было самым сложным на пленаре?"] = req.body["Что для вас было самым сложным на пленаре?"];
      session.polls.GI_part2.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
      ...
      newSession.polls.GI_part2.LECTURES["Оцените сложность содержания лекций"] = parseInt(req.body["Оцените сложность содержания лекций"]);
      newSession.polls.GI_part2.LECTURES["Насколько новым для вас было содержание лекций"] = parseInt(req.body["Насколько новым для вас было содержание лекций"]);
      newSession.polls.GI_part2.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием лекций"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения под воздействием лекций"]);
      newSession.polls.GI_part2.LECTURES["Что вам больше всего понравилось на лекциях?"] = req.body["Что вам больше всего понравилось на лекциях?"];
      newSession.polls.GI_part2.LECTURES["Что вам больше всего не понравилось на лекциях?"] = req.body["Что вам больше всего не понравилось на лекциях?"];

      newSession.polls.GI_part2.SEMINARS["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"] = req.body["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"];
      newSession.polls.GI_part2.SEMINARS["Оцените, насколько понятной для вас была установка на групповую работу"] = req.body["Оцените, насколько понятной для вас была установка на групповую работу"];
      newSession.polls.GI_part2.SEMINARS["Укажите имя и фамилию куратора, организовывавшего групповую работу"] = req.body["Укажите имя и фамилию куратора, организовывавшего групповую работу"];
      newSession.polls.GI_part2.SEMINARS["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"] = parseInt(req.body["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"]);
      newSession.polls.GI_part2.SEMINARS["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"] = parseInt(req.body["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"]);
      newSession.polls.GI_part2.SEMINARS["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = parseInt(req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"]);
      newSession.polls.GI_part2.SEMINARS["Что для вас было самым сложным в групповой работе?"] = req.body["Что для вас было самым сложным в групповой работе?"];
      newSession.polls.GI_part2.SEMINARS["Что для вас было самым сложным на пленаре?"] = req.body["Что для вас было самым сложным на пленаре?"];
      newSession.polls.GI_part2.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
