...
app.post('/polls-ai-metaphor', function(req, res) {
    ...
    User.findOne({
      ...
      if (user) {
        ...
        user.polls.AI_Metaphor.LECTURES["Насколько пунктуален был преподаватель"] = parseInt(req.body["Насколько пунктуален был преподаватель"]);
        ...
        user.polls.AI_Metaphor.SEMINARS["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"] = parseInt(req.body["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"]);
        ...
        user.polls.AI_Metaphor.SEMINARS["Сколько раз в течение одного семинарского занятия вы (в среднем) высказывались вслуха"] = parseInt(req.body["Сколько раз в течение одного семинарского занятия вы (в среднем) высказывались вслуха"]);
