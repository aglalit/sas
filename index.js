...
require('./server/electives_2019_1_1st_course.js')(app, Session, transporter, isLoggedIn, User);
require('./server/electives_2019_1_2nd_course.js')(app, Session, transporter, isLoggedIn, User);
