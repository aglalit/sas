...
app.post('/polls/global-issues-part-5', function(req, res) {
  Session.findOne({
    ...
    if (session) {
      var now = new Date();
      session.polls.GI_part5.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
      session.polls.GI_part5.LECTURES["Оцените сложность содержания лекций"] = req.body["Оцените сложность содержания лекций"];
      session.polls.GI_part5.LECTURES["Насколько новым для вас было содержание лекций"] = req.body["Насколько новым для вас было содержание лекций"];
      session.polls.GI_part5.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием лекций"] = req.body["Насколько изменились ваше мышление, знания и умения под воздействием лекций"];
      session.polls.GI_part5.LECTURES["Что вам больше всего понравилось на лекциях?"] = req.body["Что вам больше всего понравилось на лекциях?"];
      session.polls.GI_part5.LECTURES["Что вам больше всего не понравилось на лекциях?"] = req.body["Что вам больше всего не понравилось на лекциях?"];
      session.polls.GI_part5.LECTURES["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"];

      session.polls.GI_part5.SEMINARS["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"] = req.body["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"];
      session.polls.GI_part5.SEMINARS["Оцените, насколько понятной для вас была установка на групповую работу"] = req.body["Оцените, насколько понятной для вас была установка на групповую работу"];
      session.polls.GI_part5.SEMINARS["Укажите имя и фамилию куратора, организовывавшего групповую работу"] = req.body["Укажите имя и фамилию куратора, организовывавшего групповую работу"];
      session.polls.GI_part5.SEMINARS["Оцените, помог ли дополнительный такт (предзащита) в продвижении работы вашей группы?"] = req.body["Оцените, помог ли дополнительный такт (предзащита) в продвижении работы вашей группы?"];
      session.polls.GI_part5.SEMINARS["Оцените эффективность формата самостоятельной групповой работы (без куратора)"] = req.body["Оцените эффективность формата самостоятельной групповой работы (без куратора)"];
      session.polls.GI_part5.SEMINARS["Что для вас было самым интересным в групповой работе?"] = req.body["Что для вас было самым интересным в групповой работе?"];
      session.polls.GI_part5.SEMINARS["Что для вас было самым интересным на пленаре?"] = req.body["Что для вас было самым интересным на пленаре?"];
      session.polls.GI_part5.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
      ...
      var now = new Date();
      newSession.session_id = req.session.id;
      newSession.polls.GI_part5.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
      newSession.polls.GI_part5.LECTURES["Оцените сложность содержания лекций"] = parseInt(req.body["Оцените сложность содержания лекций"]);
      newSession.polls.GI_part5.LECTURES["Насколько новым для вас было содержание лекций"] = parseInt(req.body["Насколько новым для вас было содержание лекций"]);
      newSession.polls.GI_part5.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием лекций"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения под воздействием лекций"]);
      newSession.polls.GI_part5.LECTURES["Что вам больше всего понравилось на лекциях?"] = req.body["Что вам больше всего понравилось на лекциях?"];
      newSession.polls.GI_part5.LECTURES["Что вам больше всего не понравилось на лекциях?"] = req.body["Что вам больше всего не понравилось на лекциях?"];

      newSession.polls.GI_part5.SEMINARS["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"] = req.body["Что именно для вас было непонятным и самым сложным в установке на групповую работу?"];
      newSession.polls.GI_part5.SEMINARS["Оцените, насколько понятной для вас была установка на групповую работу"] = req.body["Оцените, насколько понятной для вас была установка на групповую работу"];
      newSession.polls.GI_part5.SEMINARS["Укажите имя и фамилию куратора, организовывавшего групповую работу"] = req.body["Укажите имя и фамилию куратора, организовывавшего групповую работу"];
      newSession.polls.GI_part5.SEMINARS["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"] = parseInt(req.body["Насколько хорошо куратор организует интерактивную коммуникацию в группе?"]);
      newSession.polls.GI_part5.SEMINARS["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"] = parseInt(req.body["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух?"]);
      newSession.polls.GI_part5.SEMINARS["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = parseInt(req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"]);
      newSession.polls.GI_part5.SEMINARS["Что для вас было самым сложным в групповой работе?"] = req.body["Что для вас было самым сложным в групповой работе?"];
      newSession.polls.GI_part5.SEMINARS["Что для вас было самым сложным на пленаре?"] = req.body["Что для вас было самым сложным на пленаре?"];
      newSession.polls.GI_part5.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
...
app.post('/polls/great-books', function(req, res) {
 ...
 function sessionQuestions(sess){
    ...
    if (session) {
      var now = new Date();
      session.polls.great_books_2_17["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"] = req.body["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"];
      session.polls.great_books_2_17["Как хорошо были организованы материалы курса"] = parseInt(req.body["Как хорошо были организованы материалы курса"]);
      session.polls.great_books_2_17["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = parseInt(req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"]);
      session.polls.great_books_2_17["Какой из прочитанных текстов оказал на вас наибольшее влияние? Почему?"] = req.body["Какой из прочитанных текстов оказал на вас наибольшее влияние? Почему?"];
      session.polls.great_books_2_17["Насколько полно преподаватель следовал программе курса"] = parseInt(req.body["Насколько полно преподаватель следовал программе курса"]);
      session.polls.great_books_2_17["Оцените сложность лекций для вашего понимания"] = parseInt(req.body["Оцените сложность лекций для вашего понимания"]);
      session.polls.great_books_2_17["Насколько новым для вас было содержание лекций"] = parseInt(req.body["Насколько новым для вас было содержание лекций"]);
      session.polls.great_books_2_17["Насколько изменились ваше мышление, знания и умения"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения"]);
      session.polls.great_books_2_17["Насколько хорошо преподаватель объясняет материал"] = parseInt(req.body["Насколько хорошо преподаватель объясняет материал"]);
      session.polls.great_books_2_17["Насколько хорошо преподаватель организует интерактивную коммуникацию в группе"] = parseInt(req.body["Насколько хорошо преподаватель организует интерактивную коммуникацию в группе"]);
      session.polls.great_books_2_17["Что вам больше всего понравилось в этом лекционном курсе"] = req.body["Что вам больше всего понравилось в этом лекционном курсе"];
      session.polls.great_books_2_17["Что вам больше всего не понравилось в этом лекционном курсе"] = req.body["Что вам больше всего не понравилось в этом лекционном курсе"];
      session.polls.great_books_2_17["Что для вас было самым сложным в этом лекционном курсе"] = req.body["Что для вас было самым сложным в этом лекционном курсе"];
      session.polls.great_books_2_17["Как бы вы порекомендовали улучшить этот лекционный курс"] = req.body["Как бы вы порекомендовали улучшить этот лекционный курс"];
      ...
      var newSession = new Session();
      var now = new Date();
      newSession.polls.great_books_2_17["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"] = req.body["Укажите имя и фамилию преподавателя, работавшего с вами на семинарах"];
      newSession.polls.great_books_2_17["Как хорошо были организованы материалы курса"] = parseInt(req.body["Как хорошо были организованы материалы курса"]);
      newSession.polls.great_books_2_17["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"] = parseInt(req.body["Сколько процентов обязательных текстов по этой части курса вы успевали прочесть"]);
      newSession.polls.great_books_2_17["Какой из прочитанных текстов оказал на вас наибольшее влияние? Почему?"] = req.body["Какой из прочитанных текстов оказал на вас наибольшее влияние? Почему?"];
      newSession.polls.great_books_2_17["Насколько полно преподаватель следовал программе курса"] = parseInt(req.body["Насколько полно преподаватель следовал программе курса"]);
      newSession.polls.great_books_2_17["Оцените сложность лекций для вашего понимания"] = parseInt(req.body["Оцените сложность лекций для вашего понимания"]);
      newSession.polls.great_books_2_17["Насколько новым для вас было содержание лекций"] = parseInt(req.body["Насколько новым для вас было содержание лекций"]);
      newSession.polls.great_books_2_17["Насколько изменились ваше мышление, знания и умения"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения"]);
      newSession.polls.great_books_2_17["Насколько хорошо преподаватель объясняет материал"] = parseInt(req.body["Насколько хорошо преподаватель объясняет материал"]);
      newSession.polls.great_books_2_17["Насколько хорошо преподаватель организует интерактивную коммуникацию в группе"] = parseInt(req.body["Насколько хорошо преподаватель организует интерактивную коммуникацию в группе"]);
      newSession.polls.great_books_2_17["Что вам больше всего понравилось в этом лекционном курсе"] = req.body["Что вам больше всего понравилось в этом лекционном курсе"];
      newSession.polls.great_books_2_17["Что вам больше всего не понравилось в этом лекционном курсе"] = req.body["Что вам больше всего не понравилось в этом лекционном курсе"];
      newSession.polls.great_books_2_17["Что для вас было самым сложным в этом лекционном курсе"] = req.body["Что для вас было самым сложным в этом лекционном курсе"];
      newSession.polls.great_books_2_17["Как бы вы порекомендовали улучшить этот лекционный курс"] = req.body["Как бы вы порекомендовали улучшить этот лекционный курс"];
