...
app.post('/polls/global-issues-part-2', function(req, res) {
  Session.findOne({
    ...
    if (session) {
      ...
      session.polls.GI_part2.language = 'en';
      session.polls.GI_part2.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
      session.polls.GI_part2.LECTURES["Оцените сложность содержания тематических сессий Форума"] = parseInt(req.body["Оцените сложность содержания тематических сессий Форума"]);
      session.polls.GI_part2.LECTURES["Насколько новым для вас было содержание тематических сессий Форума"] = parseInt(req.body["Насколько новым для вас было содержание тематических сессий Форума"]);
      session.polls.GI_part2.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием Форума"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения под воздействием Форума"]);
      session.polls.GI_part2.LECTURES["Что вам больше всего понравилось на Форуме?"] = req.body["Что вам больше всего понравилось на Форуме?"];
      session.polls.GI_part2.LECTURES["Что вам больше всего не понравилось на Форуме?"] = req.body["Что вам больше всего не понравилось на Форуме?"];
      ...
      newSession.polls.GI_part2.LECTURES["Насколько изменились ваше мышление, знания и умения под воздействием лекций"] = parseInt(req.body["Насколько изменились ваше мышление, знания и умения под воздействием Форума"]);
      newSession.polls.GI_part2.LECTURES["Что вам больше всего понравилось на Форуме?"] = req.body["Что вам больше всего понравилось на Форуме?"];
      newSession.polls.GI_part2.LECTURES["Что вам больше всего не понравилось на Форуме?"] = req.body["Что вам больше всего не понравилось на Форуме?"];
