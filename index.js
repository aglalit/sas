...
app.post('/polls/calvert-forum', function(req, res) {
  Session.findOne({
    ...
    if (session) {
      ...
      session.polls.Calvert.LECTURES["Что вам больше всего понравилось на Форуме?"] = req.body["Что вам больше всего понравилось на Форуме?"];
      session.polls.Calvert.LECTURES["Что вам больше всего не понравилось на Форуме?"] = req.body["Что вам больше всего не понравилось на Форуме?"];
      ...
      session.polls.Calvert.SEMINARS["Что вам больше всего понравилось в групповой работе?"] = req.body["Что вам больше всего понравилось в групповой работе?"];
      session.polls.Calvert.SEMINARS["Что вам больше всего не понравилось в групповой работе?"] = req.body["Что вам больше всего не понравилось в групповой работе?"];
      session.polls.Calvert.SEMINARS["Что для вас было самым сложным в групповой работе?"] = req.body["Что для вас было самым сложным в групповой работе?"];
      session.polls.Calvert.SEMINARS["Что вам больше всего понравилось на пленаре?"] = req.body["Что вам больше всего понравилось на пленаре?"];
      session.polls.Calvert.SEMINARS["Что вам больше всего не понравилось на пленаре?"] = req.body["Что вам больше всего не понравилось на пленаре?"];
      session.polls.Calvert.SEMINARS["Что для вас было самым сложным на пленаре?"] = req.body["Что для вас было самым сложным на пленаре?"];
      session.polls.Calvert.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
      ...
      newSession.polls.Calvert.LECTURES["Что вам больше всего понравилось на Форуме?"] = req.body["Что вам больше всего понравилось на Форуме?"];
      newSession.polls.Calvert.LECTURES["Что вам больше всего не понравилось на Форуме?"] = req.body["Что вам больше всего не понравилось на Форуме?"];
      ...
      newSession.polls.Calvert.SEMINARS["Что вам больше всего понравилось в групповой работе?"] = req.body["Что вам больше всего понравилось в групповой работе?"];
      newSession.polls.Calvert.SEMINARS["Что вам больше всего не понравилось в групповой работе?"] = req.body["Что вам больше всего не понравилось в групповой работе?"];
      newSession.polls.Calvert.SEMINARS["Что для вас было самым сложным в групповой работе?"] = req.body["Что для вас было самым сложным в групповой работе?"];
      newSession.polls.Calvert.SEMINARS["Что вам больше всего понравилось на пленаре?"] = req.body["Что вам больше всего понравилось на пленаре?"];
      newSession.polls.Calvert.SEMINARS["Что вам больше всего не понравилось на пленаре?"] = req.body["Что вам больше всего не понравилось на пленаре?"];
      newSession.polls.Calvert.SEMINARS["Что для вас было самым сложным на пленаре?"] = req.body["Что для вас было самым сложным на пленаре?"];
      newSession.polls.Calvert.SEMINARS["Как бы вы порекомендовали улучшить этот курс"] = req.body["Как бы вы порекомендовали улучшить этот курс"];
