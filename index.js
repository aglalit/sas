...
app.post('/polls/calvert-forum', function(req, res) {
  Session.findOne({
    ...
    if (session) {
      ...
      session.polls.Calvert.SEMINARS["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух (в том числе задавая вопросы)?"] = parseInt(req.body["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух (в том числе задавая вопросы)?"]);
      ...
      session.polls.Calvert.SEMINARS["Что вам больше всего понравилось в групповой работе и пленаре?"] = parseInt(req.body["Что вам больше всего понравилось в групповой работе и пленаре?"]);
      session.polls.Calvert.SEMINARS["Что вам больше всего не понравилось в групповой работе и пленаре?"] = parseInt(req.body["Что вам больше всего не понравилось в групповой работе и пленаре?"]);
      session.polls.Calvert.SEMINARS["Что для вас было самым сложным в групповой работе и пленаре?"] = parseInt(req.body["Что для вас было самым сложным в групповой работе и пленаре?"]);
      ...
      newSession.polls.Calvert.SEMINARS["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух (в том числе задавая вопросы)?"] = parseInt(req.body["Сколько раз в течение групповой работы вы (в среднем) высказывались вслух (в том числе задавая вопросы)?"]);
      ...
      newSession.polls.Calvert.SEMINARS["Что вам больше всего понравилось в групповой работе и пленаре?"] = parseInt(req.body["Что вам больше всего понравилось в групповой работе и пленаре?"]);
      newSession.polls.Calvert.SEMINARS["Что вам больше всего не понравилось в групповой работе и пленаре?"] = parseInt(req.body["Что вам больше всего не понравилось в групповой работе и пленаре?"]);
      newSession.polls.Calvert.SEMINARS["Что для вас было самым сложным в групповой работе и пленаре?"] = parseInt(req.body["Что для вас было самым сложным в групповой работе и пленаре?"]);
