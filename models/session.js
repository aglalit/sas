  ...
  polls: {
    ...
    Calvert: {
      ...
      SEMINARS: {
        ...
        "Сколько процентов обязательных текстов по этой части курса вы успевали прочесть": Number,
        "Что вам больше всего понравилось в групповой работе?": String,
        "Что вам больше всего не понравилось в групповой работе?": String,
        "Что для вас было самым сложным в групповой работе?": String,
        "Что вам больше всего понравилось на пленаре?": String,
        "Что вам больше всего не понравилось на пленаре?": String,
