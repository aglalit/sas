...
app.get('/polls/planned-absences-professors', function(req, res) {
  res.render('planned-absences-professors', {user: req.user})
});

app.post('/polls/planned-absences-professors', function(req, res) {
  Session.findOne({
...
// });
  sess.polls.planned_absences_professors = JSON.stringify(req.body);
  ...
  let mailOptions = {
    ...
    subject: "SAS — Professor's Planned Absence", // Subject line
