...
app.get('/polls/ma-2019-manirko', function(req, res) {
  res.render('ma-2019-manirko', {user: req.user})
});

app.post('/polls/ma-2019-manirko', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'Manirko — feedback', // Subject line
  ...
  sess.polls.ma_2019_manirko = JSON.stringify(req.body);
