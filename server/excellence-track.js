...
app.get('/polls/excellence-track', function(req, res) {
  res.render('excellence-track')
});

app.post('/polls/excellence-track', function(req, res) {
Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    to: 'm.agliulin@utmn.ru,a.elghandour@utmn.ru,e.burbo@utmn.ru', // list of receivers
  ...
  sess.polls.excellence_track.data = JSON.stringify(req.body);
  sess.polls.excellence_track.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
