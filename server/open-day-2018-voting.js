module.exports = function(app, Session, transporter){
  ...
  app.get('/polls/open-day-2018-voting', function(req, res) {
    res.render('open-day-2018-voting')
  });

  app.post('/polls/open-day-2018-voting', function(req, res) {
    Session.findOne({
    ...
    req.flash('info', 'Ваш выбор учтен. Благодарим за участие.');
  ...
  // });
    ...
    let mailOptions = {
      ...
      subject: 'SAS — Open Day 2018 Voting', // Subject line
