...
app.get('/polls/ba-2018-year1-module2-gb-ru', function(req, res) {
  res.render('ba-2018-year1-module2-gb-ru', {user: req.user})
});

app.post('/polls/ba-2018-year1-module2-gb-ru', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'GB — feedback (ru)', // Subject line
  ...
  sess.polls.ba_2018_year1_module2_gb_ru = JSON.stringify(req.body);
