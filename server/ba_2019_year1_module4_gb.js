module.exports = function(app, Session, transporter, isLoggedIn, User, logger) {
  ...
  app.get('/polls/ba-2019-year1-module4-gb', isLoggedIn, function(req, res) {
    res.render('ba-2019-year1-module4-gb', {
      user: req.user
    })
  });

  app.post('/polls/ba-2019-year1-module4-gb', function(req, res) {
    User.findOne({
      '_id': req.user._id
    }, function(err, user) {
      if (err)
    ...
    function parseSession(sess, req, transporter) {
      ...
      let mailOptions = {
        ...
        subject: 'GB Year 1 — feedback', // Subject line
      ...
      sess.polls.ba_2019_year1_module4_gb = JSON.stringify(req.body);
