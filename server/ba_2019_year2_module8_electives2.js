module.exports = function(app, Session, transporter, officeTransporter, isLoggedIn, User, logger) {
  ...
  app.get('/polls/ba-2019-year2-module8-electives2', isLoggedIn, function(req, res) {
    res.render('ba-2019-year2-module8-electives2', {
      user: req.user
    })
  });

  app.post('/polls/ba-2019-year2-module8-electives2', function(req, res) {
    User.findOne({
      '_id': req.user._id
    }, function(err, user) {
      if (err)
    ...
    function parseSession(sess, req, transporter) {
      ...
      let mailOptions = {
        ...
        subject: 'Elective year 2/2 — feedback', // Subject line
      ...
      sess.polls.ba_2019_year2_module8_electives2 = JSON.stringify(req.body);
