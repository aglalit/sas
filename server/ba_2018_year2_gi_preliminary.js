...
app.get('/polls/ba-2018-year1-gi-preliminary', function(req, res) {
  res.render('ba-2018-year1-gi-preliminary', {user: req.user})
});

app.post('/polls/ba-2018-year1-gi-preliminary', function(req, res) {
  Session.findOne({
