...
app.get('/polls/ba-2018-year1-module2-gi', function(req, res) {
  res.render('ba-2018-year1-module2-gi', {user: req.user})
});

app.post('/polls/ba-2018-year1-module2-gi', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'GI — feedback', // Subject line
  ...
  sess.polls.ba_2018_year1_module2_gi = JSON.stringify(req.body);
