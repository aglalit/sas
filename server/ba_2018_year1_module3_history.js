...
app.get('/polls/ba-2018-year1-module3-history', function(req, res) {
  res.render('ba-2018-year1-module3-history', {user: req.user})
});

app.post('/polls/ba-2018-year1-module3-history', function(req, res) {
  Session.findOne({
...
// });
  ...
  sess.polls.ba_2018_year1_module3_history = JSON.stringify(req.body);
