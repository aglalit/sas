...
app.get('/polls/ma-2018-strukov', function(req, res) {
...
function parseSession (sess, req, transporter){
  ...
  sess.polls.ma_2018_strukov.time = now.toLocaleString('en-US', {timeZone: 'Asia/Yekaterinburg'});
  var keyNames = Object.keys(req.body);
  keyNames.forEach((el)=>{
    console.log(req.body[el]);

      sess.polls.ma_2018_strukov[el] = req.body[el];
});
  ...
  let mailOptions = {
    ...
    subject: 'Strukov — Feedback', // Subject line
