...
app.get('/polls/ba-2018-year2-module6-electives', function(req, res) {
  res.render('ba-2018-year2-module6-electives', {user: req.user})
});

app.post('/polls/ba-2018-year2-module6-electives', function(req, res) {
  Session.findOne({
...
// });
  ...
  sess.polls.ba_2018_year2_module6_electives = JSON.stringify(req.body);
