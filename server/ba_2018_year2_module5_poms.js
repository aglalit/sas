...
app.get('/polls/ba-2018-year1-module5-poms', function(req, res) {
  res.render('ba-2018-year1-module5-poms', {user: req.user})
});

app.post('/polls/ba-2018-year1-module5-poms', function(req, res) {
  Session.findOne({
