...
app.get('/polls/ba-2018-year1-module2-gb-en', function(req, res) {
  res.render('ba-2018-year1-module2-gb-en', {user: req.user})
});

app.post('/polls/ba-2018-year1-module2-gb-en', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'GB — feedback (en)', // Subject line
  ...
  sess.polls.ba_2018_year1_module2_gb_en = JSON.stringify(req.body);
