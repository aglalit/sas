module.exports = function(app, Session, transporter, officeTransporter, isLoggedIn, User, logger) {
  ...
  app.get('/polls/ba-2019-year1-module4-tfy', isLoggedIn, function(req, res) {
    res.render('ba-2019-year1-module4-tfy', {
      user: req.user
    })
  });

  app.post('/polls/ba-2019-year1-module4-tfy', function(req, res) {
    User.findOne({
      '_id': req.user._id
    }, function(err, user) {
      if (err)
    ...
    function parseSession(sess, req, transporter) {
      ...
      let mailOptions = {
        ...
        subject: 'TFY — feedback', // Subject line
      ...
      sess.polls.ba_2019_year1_module4_tfy = JSON.stringify(req.body);
