...
app.get('/polls/ba-2019-year1-module3-gb', function(req, res) {
  res.render('ba-2019-year1-module3-gb', {user: req.user})
});

app.post('/polls/ba-2019-year1-module3-gb', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'GB — feedback', // Subject line
  ...
  sess.polls.ba_2019_year1_module3_gb = JSON.stringify(req.body);
