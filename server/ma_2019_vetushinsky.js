...
app.get('/polls/ma-2019-vetushinsky', function(req, res) {
  res.render('ma-2019-vetushinsky', {user: req.user})
});

app.post('/polls/ma-2019-vetushinsky', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    to: 'marat.goya@gmail.com,a.shelyagina@utmn.ru', // list of receivers
    subject: 'Vetushinsky — feedback', // Subject line
  ...
  sess.polls.ma_2019_vetushinsky = JSON.stringify(req.body);
