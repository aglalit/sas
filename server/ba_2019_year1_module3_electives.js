...
app.get('/polls/ba-2019-year1-module3-electives', function(req, res) {
  res.render('ba-2019-year1-module3-electives', {user: req.user})
});

app.post('/polls/ba-2019-year1-module3-electives', function(req, res) {
  Session.findOne({
...
// });
  ...
  sess.polls.ba_2019_year1_module3_electives = JSON.stringify(req.body);
