...
app.get('/polls/ba-2018-year1-module2-qm', function(req, res) {
  res.render('ba-2018-year1-module2-qm', {user: req.user})
});

app.post('/polls/ba-2018-year1-module2-qm', function(req, res) {
  Session.findOne({
  ...
  req.flash('info', 'Ваша заявка принята. Благодарим за обратную связь.');
...
// });
  ...
  sess.polls.ba_2018_year1_module2_qm = JSON.stringify(req.body);
