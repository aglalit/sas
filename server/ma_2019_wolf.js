...
app.get('/polls/ma-2019-wolf', function(req, res) {
  res.render('ma-2019-wolf', {user: req.user})
});

app.post('/polls/ma-2019-wolf', function(req, res) {
  Session.findOne({
...
// });
  ...
  let mailOptions = {
    ...
    subject: 'Fedorova/Wolf — feedback', // Subject line
  ...
  sess.polls.ma_2019_wolf = JSON.stringify(req.body);
