  ...
  function parseSession (sess, req, transporter) {
    ...
    <html>
     <head>
      ...
      <title>Регистрация I Интенсив Выбор направления подготовки и профессиональная траектория</title>
      <!--[if (mso 16)]>
        <style type="text/css">
