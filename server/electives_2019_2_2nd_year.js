module.exports = function(app, Session, transporter, isLoggedIn, User){
  ...
  app.post('/polls/electives-2019-2-2nd-year', function(req, res) {
    ...
    req.flash('info', `Your choice is submitted (ELECTIVE 1: 1st priority — ${req.body["elective1"]}; 2nd priority — ${req.body["elective2"]}; ELECTIVE 2: 1st priority — ${req.body["elective3"]}; 2nd priority — ${req.body["elective4"]};). In case of mistake, you can make your choice again. Thanks for participation.`);
    let emailBody = '';
